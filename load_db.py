...
class DocumentDatabase:
    # SQLite database handler for extracted documents
    ...
    def insert_constitution_record(self, record: Dict):
        # insert single constitution record
        self.cursor.execute("""
    ...
    def insert_mathematics_record(self, record: Dict):
        # insert single mathematics record
        self.cursor.execute("""
    ...
    def bulk_insert(self, records: List[Dict], doc_type: str):
        # bulk insert based on document type
    ...
    def insert_chunk_with_embedding(self, chunk: Dict, doc_type: str):
        # insert semantic chunk with embedding
        import pickle
    ...
    def get_all_chunks(self, doc_type: str = None) -> List[Dict]:
        # retrieve chunks optionally filtered by type
        import pickle
    ...
    def search_constitution_by_article(self, article_number: str) -> List[Dict]:
        # search constitution by article
        self.cursor.execute("""
